    ...
    return MultiBlocProvider(
      providers: [
        ...
        Provider<VendorRepository>(
          create: (context) => VendorRepositoryImpl(
            firestoreDataSource: context.read<FirestoreDataSource>(),
          ),
        ),
        ...
        Provider<SignInWithEmailAndPasswordUseCase>(
          create: (context) => SignInWithEmailAndPasswordUseCase(
            context.read<AuthRepository>(),
          ),
        ),
        Provider<SignUpWithEmailAndPasswordUseCase>(
          create: (context) => SignUpWithEmailAndPasswordUseCase(
            context.read<AuthRepository>(),
          ),
        ),
        ...
        Provider<GetAuthStateChangesUseCase>(
          create: (context) => GetAuthStateChangesUseCase(
            context.read<AuthRepository>(),
          ),
        ),
        Provider<SaveUserToFirestoreUseCase>(
          create: (context) => SaveUserToFirestoreUseCase(
            context.read<AuthRepository>(),
          ),
        ),
        ...
        Provider<GetOrdersUseCase>(
          create: (context) => GetOrdersUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        Provider<GetOrdersByStatusUseCase>(
          create: (context) => GetOrdersByStatusUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        Provider<GetOrderUseCase>(
          create: (context) => GetOrderUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        ...
        Provider<UpdateOrderUseCase>(
          create: (context) => UpdateOrderUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        Provider<UpdateClientReceivedUseCase>(
          create: (context) => UpdateClientReceivedUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        Provider<DeleteOrderUseCase>(
          create: (context) => DeleteOrderUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        Provider<DeleteCompletedOrdersUseCase>(
          create: (context) => DeleteCompletedOrdersUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        Provider<UploadImagesForClientUseCase>(
          create: (context) => UploadImagesForClientUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        Provider<DeleteOrderImagesUseCase>(
          create: (context) => DeleteOrderImagesUseCase(
            context.read<OrderRepository>(),
          ),
        ),
        ...
        Provider<GetVendorsUseCase>(
          create: (context) => GetVendorsUseCase(
            context.read<VendorRepository>(),
          ),
        ),
        Provider<GetVendorUseCase>(
          create: (context) => GetVendorUseCase(
            context.read<VendorRepository>(),
          ),
        ),
        Provider<CreateVendorUseCase>(
          create: (context) => CreateVendorUseCase(
            context.read<VendorRepository>(),
          ),
        ),
        Provider<UpdateVendorUseCase>(
          create: (context) => UpdateVendorUseCase(
            context.read<VendorRepository>(),
          ),
        ),
        Provider<DeleteVendorUseCase>(
          create: (context) => DeleteVendorUseCase(
            context.read<VendorRepository>(),
          ),
        ),
        ...
        Provider<GetClientUseCase>(
          create: (context) => GetClientUseCase(
            context.read<ClientRepository>(),
          ),
        ),
        Provider<GetClientByNameAndPhoneUseCase>(
          create: (context) => GetClientByNameAndPhoneUseCase(
            context.read<ClientRepository>(),
          ),
        ),
        ...
        Provider<DeleteClientsByNameAndPhoneUseCase>(
          create: (context) => DeleteClientsByNameAndPhoneUseCase(
            context.read<ClientRepository>(),
          ),
        ),
        ...
        BlocProvider<AuthBloc>(
          create: (context) => AuthBloc(
            signInWithEmailAndPassword: context.read<SignInWithEmailAndPasswordUseCase>(),
            signUpWithEmailAndPassword: context.read<SignUpWithEmailAndPasswordUseCase>(),
        ...
        BlocProvider<OrderBloc>(
          create: (context) => OrderBloc(
            ...
            updateClientReceived: context.read<UpdateClientReceivedUseCase>(),
            uploadImagesForClient: context.read<UploadImagesForClientUseCase>(),
            deleteOrder: context.read<DeleteOrderUseCase>(),
            deleteCompletedOrders: context.read<DeleteCompletedOrdersUseCase>(),
            deleteClientsByNameAndPhone: context.read<DeleteClientsByNameAndPhoneUseCase>(),
          ),
        ),
